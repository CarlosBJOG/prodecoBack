jQuery(function($) {
  ...
  $('#smartwizard-1').smartWizard({
    ...
    toolbarSettings: {
          ...
          toolbarExtraButtons: [
              $('<button class="btn btn-secondary sw-btn-prev" id="tab_anterior"><i class="fa fa-arrow-left mr-1"></i> Anterior</button>'),

              $('<button class="btn btn-success sw-btn-next sw-btn-hide" id="tab_siguiente">Siguiente <i class="fa fa-arrow-right mr-1"></i></button>'),

              $('<button class="btn btn-purple sw-btn-finish" id="tab_finalizar">Finalizar <i class="fa fa-check mr-1"></i></button>')
              .on('click', function(){
                  window.location.href="cartera.php";
              }),
...
// Form Validation
 ...
 $('#platform')
 // .css('width','200px').select2({allowClear:true})
 .on('change', function(){
