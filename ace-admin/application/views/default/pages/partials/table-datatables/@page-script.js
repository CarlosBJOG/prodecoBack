...
jQuery(function($) {
  ...
  var $_table = $(tableId).DataTable({
    ...
    language: {
      search: '<i class="fa fa-search pos-abs mt-2 ml-2 text-success-m2"></i>',
  ...
  .find('.dataTables_filter').appendTo('.page-tools').find('input').addClass('form-control text-success-d2 border-none border-b-2 radius-0 shadow-none bgc-transparent pl-35 mr-1')
  //and add a "plus" button
  //.end().append('<button hidden data-rel="tooltip" type="button" class="btn radius-round btn-outline-primary border-2 btn-sm ml-2" title="Add New"><i class="fa fa-plus"></i></button>');
