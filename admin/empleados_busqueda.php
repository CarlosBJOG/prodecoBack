            ...
            <div class="col-sm-12 col-lg-12">                                        
                <div class="row">
                    <div class="mx-auto col-12">
                        <div class="card">
                            <h2 class="text-success p-4">Lista de empleados</h4>
                            <div class="card-body">
                            ...
                            <thead class="text-dark-m3 bgc-grey-l4 text-uppercase text-85" >
                                <tr class="small">
                                    ...
                                    <th class="border-0">Apellido Paterno</th>
                                    <th class="border-0">Apellido Materno</th>
...
<?php 
            ...
            require("../views/empleados/view_edit_permiso.php");
            require("../views/empleados/view_edit_usuario.php");
            require("../views/empleados/view_add_familiar.php");
            require("../views/empleados/view_tablas_familiares.php");
            require("../views/empleados/view_edit_fam.php");
?>
