...
<div class="page-content container container-plus px-md-4 px-xl-5">
        ...
        <div class="row mt-35">
            ...
            <figure class="mx-auto text-center">
              <img src="../styles/reestructuracion.jpg" width="300">
            </figure>
            <h2 class="text-grey-d1 pb-0 mb-3 mb-md-0 text-center">
            ...
            <div class="page-header pb-2 flex-column flex-sm-row align-items-start align-items-sm-center">
              <h4 class="font-light text-orange-d2">
                <span class="b-underline-4">Reestructuración</span>
                &nbsp;&nbsp;&nbsp;
...
$(document).ready(function(){
    ...
    datatable_creditos_reestructuracion();
});
