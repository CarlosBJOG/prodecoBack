  ...
  ?>
    ...
    <div class="row justify-content-around mt-4">
        ...
        <div class="col-2 col-sm-2 col-lg-2 my-1 my-lg-0 px-sm-1 px-lg-0">
            ...
            <h1 class="text-grey-d2 pb-0 mb-3 mb-md-0 text-center">Desembolso</h1>
            <hr>
      ...
      <div class="col-12 col-lg-9">
        <div>
          <h5 class="font-light text-orange-d2"> 
            <span><a <?php if($_SESSION["tipo_usuario"]!='1' && $_SESSION["tipo_usuario"]!='6') echo "hidden";  ?> href="cartera_transito_sup.php" class="text-orange-d2">Cartera en tránsito (Supervisor)</a></span>&nbsp;&nbsp;&nbsp;&nbsp;
            <span class="b-underline-4" ><a href="cartera_transito_cajero.php" style="text-decoration: none;" class="font-light text-orange-d2"> Listado de Cartera en tránsito (Cajero)</a></span>&nbsp;&nbsp;&nbsp; 
          </h5>
            ...
            <table id="datatable" class="table table-bordered table-bordered-x text-dark-m2 text-95 brc-secondary-l1" >
              <thead class="text-dark-m3 bgc-grey-l4 text-uppercase text-85" >
                <tr class="small">
                  ...
                  <th class="border-0" style="width:40%">Nombre</th>
...
<script type="text/javascript">
    ...
    datatable_caja_transito_cajero();
	});
</script>
