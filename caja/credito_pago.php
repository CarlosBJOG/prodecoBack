    ...
    <div class="row justify-content-around mt-4">
        ...
        <div class="col-2 col-sm-2 col-lg-2 my-1 my-lg-0 px-sm-1 px-lg-0">
            <figure class="mx-auto text-center">
              <img src="../styles/aplicacion_pago.jpg" width="300">
            </figure>
            <h1 class="text-grey-d2 pb-0 mb-3 mb-md-0 text-center">Aplicación de Pago</h1>
            <hr>
          ...
          <div class="row">
            <div class="col-9">
              <h5 class="font-light text-orange-d2"> 
                ...
                &nbsp;&nbsp;&nbsp; 
                <span class="b-underline-4"><a href="credito_pago.php" style="text-decoration: none;" class="font-light text-orange-d2">Aplicaci&oacute;n de pago</a></span>
              </h5>
            </div>
            <!-- <div class="col-3 text-right">
                  <a class="btn btn-success btn-sm text-white" href="../caja/credito_pago_registrar.php">
                    <i class="fa fa-file-pdf-o"></i>&nbsp;Registrar Pago
                  </a>
              </div> -->
            </div>
            ...
            <table id="datatable" class="table table-bordered table-bordered-x text-dark-m2 text-95 brc-secondary-l1" >
              <thead class="text-dark-m3 bgc-grey-l4 text-uppercase text-85" >
                <tr class="small">
                  ...
                  <th class="border-0">Folio<br> Crédito</th>
                  <th class="border-0">Folio<br> Pago</th>
