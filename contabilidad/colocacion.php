    ...
    <div class="row justify-content-around mt-4">
      ...
      <div class="col-12 col-sm-12 col-lg-3 my-1 my-lg-0 px-sm-1 px-lg-0">
            <figure class="mx-auto text-center">
              <img src="../styles/polizas.jpg" width="300">
            </figure>
          ...
          <div class="row">
            <div class="col-sm-8 col-md-8 col-lg-8">
              <h4 class="font-light text-orange-d2">
                <span class="b-underline-4">Colocación</span>&nbsp;&nbsp;&nbsp; 
                <span><a href="colocacion_egreso.php" class="text-orange-d2">Pólizas Egreso</a></span>&nbsp;&nbsp;&nbsp;
              </h4>
            </div>
            <div class="col-sm-4 col-md-4 col-lg-4 text-right">
              <div class="btn-group">
                <button type="button" class="btn btn-success btn-sm dropdown-toggle" data-toggle="dropdown">
                  <i class="fa fa-file-pdf-o"></i>&nbsp;Generar Póliza Egreso&nbsp;<span class="fas fa-sort-down"></span>
                </button>
                <ul class="dropdown-menu" role="menu">
                  <li><a href="#" onclick="cargar_poliza_egreso(1)"><i class="fas fa-hand-holding-usd"></i>&nbsp;Efectivo</a></li>
                  <li><a href="#" onclick="cargar_poliza_egreso(2)"><i class="far fa-credit-card"></i>&nbsp;Transferencia</a></li>
                  <li><a href="#" onclick="cargar_poliza_egreso(3)"><i class="far fa-credit-card"></i>&nbsp;Cheque</a></li>
                </ul>
              </div>
...
<form id="formPoliza" name="formPoliza" action="">
  <div class="modal fade modal-lg" id="modalPoliza" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-dialog-scrollable modal-dialog-lg" role="document">
      <div class="modal-content">

        <div class="modal-header">
          <h5 class="modal-title text-success">Póliza Egreso1</h5>
          <input hidden type="text" name="nuevo_estatus_desembolso" id="nuevo_estatus_desembolso">
          <input hidden type="text" name="tipo_poliza_egreso" id="tipo_poliza_egreso">
        ...
        <div class="modal-body ace-scrollbar">
          <div id="formPoliza"  aria-labelledby="formPoliza" >
              ...
              <div class="row brc-grey-l1">
                    ...
                    <div class="col-sm-6 col-md-6 col-lg-6">
                      <div class="col-sm-12 col-md-12 col-lg-12 card-title"><b>Monto</b></div>
                      <div class="col-sm-12 col-md-12 col-lg-12 text-grey text-400" id="montos"></div>
                    </div>
                    <div class="col-sm-12 col-md-12 col-lg-12"><hr class="bgc-primary"></div>
                  ...
                  <div class="card col-sm-12 col-md-12 col-lg-12 brc-default-m3" style="margin-bottom: 10px;">
...
<script type="text/javascript">
    ...
    datatable_colocacion();
    $('#cuenta_contable1').select2();
    $('#cuenta_contable2').select2();
    $( "#formPoliza").validate({errorClass: 'text-error'});
