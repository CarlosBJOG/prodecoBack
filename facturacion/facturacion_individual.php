...
<div class="col-12 col-lg-9">
  ...
  <h5 class="font-light text-orange-d2"> 
    <span class=""><a  href="facturacion.php" style="text-decoration: none;" class="font-light text-orange-d2">Publico General</a></span> &nbsp;&nbsp;&nbsp;
    <span class="b-underline-4"><a  href="facturacion_individual.php" style="text-decoration: none;" class="font-light text-orange-d2">Individual</a></span> &nbsp;&nbsp;&nbsp;
  </h5>
...
<script type="text/javascript" src="../ace-admin/node_modules/jquery/dist/jquery.js"></script>
      ...
      <script src="../js/func_fact_individual.js"></script>
