...
<div class="page-content container container-plus px-md-4 px-xl-5">
        <div class="row mt-35">
            ...
            <img src="../styles/ilustracion-cartera.png" style=" border-radius:150px; " width="150">
                ...
                <h2 class="text-grey-d2 pb-0 mb-3 mb-md-0 text-center">Garant&iacute;as Dep&oacute;sito</h2>
                <hr>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm">
                        <a href="#"  style="text-decoration: none;" id="tablaIndividual"><h5 class="text-secondary-d2 pb-0 mb-3 mb-md-0 text-center mt-3">Tabla de Garant&iacute;as</h5></a>
                    </div>
                    ...
                    <div class="row">
                        <div class="mx-auto col-12">
                            <div class="table-responsive-md" style="min-width:100%;">
                                <table id="tablaGarantias" class="table table-bordered table-bordered-x text-dark-m2 text-95 brc-secondary-l1" >
