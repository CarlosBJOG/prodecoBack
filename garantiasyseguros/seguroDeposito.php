...
<div class="page-content container container-plus px-md-4 px-xl-5">
        <div class="row mt-35">
            ...
            <img src="../styles/ilustracion-cartera.png" style=" border-radius:150px; " width="150">
                ...
                <h2 class="text-grey-d2 pb-0 mb-3 mb-md-0 text-center">Seguros</h2>
                <hr>
            ...
            <div class="row"> 
                ...
                <div class="col-sm mt-3">
                    <h5 class="font-light text-orange-d2  " style="font-size: 4vh; margin: 1px;" >
                        <span class="b-underline-4 mt-2 col"><a  href="gastos_caja.php" style="text-decoration: none;" class="font-light text-orange-d2 ">Seguro Dep&oacute;sito</a></span>&nbsp;&nbsp;&nbsp;
                    </h5>
                </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm">
                        <a href="#"  style="text-decoration: none;" id="tablaIndividual"><h5 class="text-secondary-d2 pb-0 mb-3 mb-md-0 text-center mt-3">Tabla de Creditos Individuales</h5></a>
                    </div>
                    <div class="col-sm">
                        <a href="#"  style="text-decoration: none;" id="tablaGrupal"><h5 class="text-secondary-d2 pb-0 mb-3 mb-md-0 text-center mt-3">Tabla de Creditos Grupales</h5></a>
                    </div>
            ...
            <div class="row justify-content-sm-center justify-content-md-center justify-content-lg-center mt-1"id="divTablaGrup" >
                <div class="col-sm-12 col-lg-12">                                        
                    <div class="row">
                        <div class="mx-auto col-12">

                            <div class="table-responsive-md" style="min-width:100%;">
                                <table id="tablaSegurosGrupal" class="table table-bordered table-bordered-x text-dark-m2 text-95 brc-secondary-l1" >
                                    <thead class="text-dark-m3 bgc-grey-l4 text-uppercase text-85">
                                        <tr class="medium text-center">
                                  

                                            <th class="border-0 ">ID CREDITO</th>
                                            <th class="border-0">NOMBRE DE GRUPO</th>
                                            <th class="border-0">NOMBRE DE CLIENTE</th>
                                            <th class="border-0">FECHA DE CREACI&Oacute;N</th>
                                            <th class="border-0">FECHA DE PRIMER PAGO</th>
                                            <th class="border-0">MONTO</th>
                                            <th class="border-0">APLICAR SEGURO</th>
                                        </tr>
                                    </thead>
            ...
            <div class="row justify-content-sm-center justify-content-md-center justify-content-lg-center mt-1"id="divTablaInd" >
                <div class="col-sm-12 col-lg-12">                                        
                    <div class="row">
                        <div class="mx-auto col-12">

                            <div class="table-responsive-md" style="min-width:100%;">
                                <table id="tablaSeguros" class="table table-bordered table-bordered-x text-dark-m2 text-95 brc-secondary-l1" >
                                    <thead class="text-dark-m3 bgc-grey-l4 text-uppercase text-85">
                                        <tr class="medium text-center">
                                        <th class="border-0 ">ID CREDITO</th>
            ...
            <div class="row justify-content-sm-center justify-content-md-center justify-content-lg-center mt-1"id="divTablaImprimir" >
                <div class="col-sm-12 col-lg-12">                                        
                    <div class="row">
                        <div class="mx-auto col-12">

                            <div class="table-responsive-md" style="min-width:100%;">
                                <table id="tablasImprimir" class="table table-bordered table-bordered-x text-dark-m2 text-95 brc-secondary-l1" >
                                    <thead class="text-dark-m3 bgc-grey-l4 text-uppercase text-85">
                                        <tr class="medium text-center">
                                        <th class="border-0 ">ID</th>
                                            <th class="border-0">CREDITO</th>
                                            <th class="border-0">CLIENTE</th>
                                            <th class="border-0">MONTO DE SEGURO</th>
        ...
        <?php
        require("../views/garantiasSeguros/view_seguro_deposito.php");
    ?>
