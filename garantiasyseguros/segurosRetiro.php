...
<div class="page-content container container-plus px-md-4 px-xl-5">
        <div class="row mt-35">
            ...
            <img src="../styles/ilustracion-cartera.png" style=" border-radius:150px; " width="150">
                ...
                <h2 class="text-grey-d2 pb-0 mb-3 mb-md-0 text-center">Seguros Retiro</h2>
                <hr>
            ...
            <div class="row"> 
                ...
                <div class="col-sm mt-1">
                    <h5 class="font-light text-orange-d2  " style="font-size: 4vh; margin: 1px;" >
                        <span class="b-underline-4 mt-2 col"><a  href="gastos_caja.php" style="text-decoration: none;" class="font-light text-orange-d2 ">Retiro de Seguros</a></span>&nbsp;&nbsp;&nbsp;
                    </h5>
                </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm">
                        <a href="#"  style="text-decoration: none;" id="tablaIndividual"><h5 class="text-secondary-d2 pb-0 mb-3 mb-md-0 text-center mt-3">Tabla de Seguros</h5></a>
                    </div>
                    ...
                    <div class="row">
                        <div class="mx-auto col-12">
                            <div class="table-responsive-md" style="min-width:100%;">
                                <table id="tablaRetiro" class="table table-bordered table-bordered-x text-dark-m2 text-95 brc-secondary-l1" >
                                    <thead class="text-dark-m3 bgc-grey-l4 text-uppercase text-85">
                                        ...
                                        <th class="border-0 ">ID</th>
                                            ...
                                            <th class="border-0">RETIRAR/REIMPRIMIR</th>
                                        </tr>
                                    </thead>
    ...
    <?php
        require("../views/garantiasSeguros/view_retiro_seguro.php");
    ?>
...
<script>
     $(document).ready(function(){
        ...
        moduloGseguros.initRetiroSeguro();
