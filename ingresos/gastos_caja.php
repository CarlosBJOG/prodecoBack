...
<div class="page-content container container-plus px-md-4 px-xl-5">
        <div class="row mt-35">
            ...
            <img src="../styles/cobranza.jpg" style=" border-radius:150px; " width="150">
                </figure>
                <h2 class="text-grey-d2 pb-0 mb-3 mb-md-0 text-center">Gastos Cobranza</h2>
                <hr>
            ...
            <div class="row">
                ...
                <div class="col-sm mt-3">
                    <h5 class="font-light text-orange-d2  " style="font-size: 4vh; margin: 1px;">
                        <span class="col"><a <?php if($_SESSION["tipo_usuario"]!='1' && $_SESSION["tipo_usuario"]!='2' && $_SESSION["tipo_usuario"]!='4'  && $_SESSION["tipo_usuario"]!='6') echo "hidden"; ?> href="gastos_cobranza.php" style="text-decoration: none;" class="font-light text-orange-d2">Gastos Cobranza (Promotor)</a></span>&nbsp;&nbsp;&nbsp; 
                    </h5>
                </div>
                </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm">
                        <h5 class="text-secondary-d2 pb-0 mb-3 mb-md-0 text-center mt-3" >Tabla de cobranza</h5>
                    </div>
                    ...
                    <div class="row">
                        <div class="mx-auto col-12">
                            ...
                            <div class="table-responsive-md" style="min-width:100%;">
                                <table id="tablagastosCajero" class="table table-bordered table-bordered-x text-dark-m2 text-95 brc-secondary-l1" >
                                    <thead class="text-dark-m3 bgc-grey-l4 text-uppercase text-85">
                                        <tr class="medium text-center">
                                            ...
                                            <th class="border-0">IMPRIMIR/APLICAR/ELIMINAR</th>
                                        </tr>
                                    </thead>
