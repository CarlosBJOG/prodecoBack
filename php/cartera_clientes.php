                ...
                <div class="d-flex align-items-center">
                  ...
                  <div class="text-white">
                    ...
                    <div class="text-uppercase text-85 text-600 letter-spacing">
                      ...
                      <a href="#"><i class="fa fa-file-excel-o text-white ml-3 text-120"></i></a>
                      <a href="#"><i class="fa fa-file-pdf-o text-white ml-2 text-120"></i></a>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div class="d-flex align-items-center">
                  ...
                  <div class="text-white">
                    ...
                    <div class="text-uppercase text-85 text-600 letter-spacing">
                      ...
                      <label>
                        <input type="checkbox" class="align-middle input-sm" autocomplete="off">
                        <small>
                          <span class="align-middle" id="tooltip-descargar" data-toggle="tooltip" data-placement="bottom" title="Marcar para descargar archivo completo">
                            Descargar todo
                          </span>
                        </small>
                      </label>                    
