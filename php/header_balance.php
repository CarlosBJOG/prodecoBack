<?php
//Control de accesos: solo administrador, contador. 
          ...
          <div class="container container-plus">
            ...
            <div class="navbar-content d-none d-xl-flex border-l-1 brc-grey-l3">
                <ol class="breadcrumb pl-2 ml-3">
                  ...
                  <?php if($actual == "/prodeco/balance/balance.php"){ ?>
                        
                        <li class="breadcrumb-item text-dark-tp5"> <a class="text-dark-tp3" href="balance.php">Balance</a></li>
