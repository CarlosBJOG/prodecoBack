        ...
        <div class="navbar-inner">
          <div class="container container-plus">
            ...
            <div class="navbar-content d-none d-xl-flex border-l-1 brc-grey-l3">
              ...
              <?php }elseif($actual == "/prodeco/caja/credito_pago.php"){ ?>
                  <li class="breadcrumb-item text-dark-tp5"> <a class="text-dark-tp3" href="credito_pago.php">Aplicación de pago</a></li>

              <?php }elseif($actual == "/prodeco/caja/credito_pago_registrar.php"){ ?>
                  <li class="breadcrumb-item text-dark-tp5"> <a class="text-dark-tp3" href="credito_pago_registrar.php">Registro pago</a></li>


              <?php }elseif($actual == "/prodeco/caja/cartera_transito_sup.php"){ ?>
                  <li class="breadcrumb-item text-dark-tp5"> <a class="text-dark-tp3" href="credito_pago.php">Cartera en transito (sup)</a></li>
            ...
            <div class="d-inline-flex align-items-center input-floating-label brc-success-m1 px-lg-0">
                <ol class="breadcrumb pl-2 ml-3">
                    ...
                    <li class="nav-item">
                        <a class="nav-link brc-success d-style" href="cartera_transito_cajero.php">
                            <i class="fas fa-coins text-success-m2 mr-3px"></i>
                            <span class="d-n-active text-dark-tp5" >Desembolso</span>
                            <span class="d-active text-success">Desembolso</span>
                        </a>
                    </li>

                    <li class="nav-item">
                        <a class="nav-link brc-success d-style" href="credito_pago_registrar.php">
                            <i class="fa fa-cash-register text-success-m2 mr-3px"></i>
                            <span class="d-n-active text-dark-tp5">Registro pago</span>
                            <span class="d-active text-success">Registro pago</span>
                        </a>
                    </li>

                    <li class="nav-item">
                        <a class="nav-link brc-success d-style" href="credito_pago.php">
                            <i class="fas fa-cart-arrow-down text-success-m2 mr-3px"></i>
                            <span class="d-n-active text-dark-tp5">Aplicación de pago</span>
                            <span class="d-active text-success">Aplicación de pago</span>
                        </a>
                    </li>
