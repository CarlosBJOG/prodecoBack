          ...
          <div class="container container-plus">
            ...
            <div class="navbar-content d-none d-xl-flex border-l-1 brc-grey-l3">
                <ol class="breadcrumb pl-2 ml-3">
                  ...
                  <?php if($actual == "/prodeco/cartera/cartera_clientes.php"){ ?>

                    <li class="breadcrumb-item text-dark-tp5"> <a class="text-dark-tp3" href="index.php">Clientes</a></li>

                  <?php }elseif($actual == "/prodeco/cartera/cartera_creditos.php"){ ?>
                    <li class="breadcrumb-item text-dark-tp5"> <a class="text-dark-tp3" href="index.php">Cr&eacute;ditos</a></li>
                  <?php }?>
                ...
                <ul class="nav nav-compact has-active-border">
                    <li class="nav-item dropdown">
                      <div class="navbar-content flex-grow-0 ml-auto">
                        <a href="../cartera/clientes_alta.php">
                    ...
                    <li class="nav-item dropdown">
                      <div class="navbar-content flex-grow-0 ml-auto">
                          <a href="../cartera/form-nuevocredito.php?tipo=2">
