...
if($_SESSION["tipo_usuario"] != "1" && $_SESSION["tipo_usuario"] != "4" && $_SESSION["tipo_usuario"] != "5" && $_SESSION["tipo_usuario"] != "6"){
  echo "<script> 
          ...
          <div class="container container-plus">
            ...
            <div class="navbar-content d-none d-xl-flex border-l-1 brc-grey-l3">
                <ol class="breadcrumb pl-2 ml-3">
                  ...
                  <li class="breadcrumb-item text-dark-tp5"> <a class="text-dark-tp3" href="index.php">Caja</a></li>
              ...
              <?php }elseif($actual == "/prodeco/ingresos/buro_credito_cajero.php"){ ?>
                  <li class="breadcrumb-item text-dark-tp5"> <a class="text-dark-tp3" href="index.php">Buró de crédito</a></li>
              <?php } elseif($actual == "/prodeco/ingresos/gastos_caja.php"){?>

    
                  <li class="breadcrumb-item text-dark-tp5"> <a class="text-dark-tp3" href="index.php">Gastos cobranza</a></li>
              <?php } elseif($actual == "/prodeco/ingresos/quitar_pago.php"){ ?>
                <li class="breadcrumb-item text-dark-tp5"> <a class="text-dark-tp3" href="index.php">Quitar pago</a></li>
                <?php }?>
                </ol>
            </div>
            ...
            <div class="d-inline-flex align-items-center input-floating-label brc-success-m1 px-lg-0">
                <ol class="breadcrumb pl-2 ml-3">
                    <li class="nav-item">
                        <a class="nav-link brc-success d-style" href="buro_credito_cajero.php">
                            <i class="fas fa-percentage text-success-m2 mr-3px"></i>
                            <span class="d-n-active text-dark-tp5">Condonación de intereses</span>
                            <span class="d-active text-success">Condonación de intereses</span>
                        </a>
                    </li>

                    <li class="nav-item">
                        <a class="nav-link brc-success d-style" href="gastos_caja.php">
                            <i class="fas fa-file-signature text-success-m2 mr-3px"></i>
                            <span class="d-n-active text-dark-tp5" >Reestructuración</span>
                            <span class="d-active text-success">Reestructuración</span>
                        </a>
                    </li>

                    <li class="nav-item">
                        <a class="nav-link brc-success d-style" href="">
                            <i class="fa fa-file-contract text-success-m2 mr-3px"></i>
                            <span class="d-n-active text-dark-tp5">Renovación</span>
                            <span class="d-active text-success">Renovación</span>
                        </a>
                    </li>
                    ...
                    <li class="nav-item">
                        <a class="nav-link brc-success d-style" href="quitar_pago.php">
                            <i class="fas fa-exclamation-triangle text-success-m2 mr-3px"></i>
                            <span class="d-n-active text-dark-tp5">Castigo de crédito</span>
                            <span class="d-active text-success">Castigo de crédito</span>
                        </a>
                    </li>
