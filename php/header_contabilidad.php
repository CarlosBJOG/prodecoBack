<?php
//Control de accesos: solo administrador y contador
...
<head>
 ...
 <link rel="stylesheet" type="text/css" href="../ace-admin/application/views/default/pages/partials/icons/@page-style.cs">
 <link rel="stylesheet" type="text/css" href="../ace-admin/application/css/src/_sidebar-liststyle.scss">

 <link rel="stylesheet" type="text/css" href="../ace-admin/node_modules/jam-icons/css/jam.min.css">
    <link rel="stylesheet" type="text/css" href="../ace-admin/node_modules/eva-icons/style/eva-icons.css">
          ...
          <div class="container container-plus">
            ...
            <div class="navbar-content d-none d-xl-flex border-l-1 brc-grey-l3">
                <ol class="breadcrumb pl-2 ml-3">
                  ...
                  <li class="breadcrumb-item text-dark-tp5"> <a class="text-dark-tp3" href="index.php">Contabilidad</a></li>
                </ol>
            </div>
              ...
              <div class="navbar-nav">
                <ul class="nav nav-compact has-active-border">
                  <!--<ul class="nav nav-tabs nav-spaced nav-tabs-simple nav-tabs-scroll border-b-1 brc-secondary-l2 mx-n3 mx-md-0 px-3 px-md-0" role="tablist">-->
                    <li class="nav-item">
                    <a class="nav-link brc-success d-style" href="./colocacion.php">
                        <i class="fa fa-money text-success-m2 mr-3px"></i>
                        <span class="d-n-active">Colocación</span>
                        <span class="d-active text-success">Colocación</span>
                    </a>
                    </li>
                    <!-- <li class="nav-item">
                    <a class="nav-link brc-success d-style" href="./caja.php">
                    ...
                    <!-- <li class="nav-item">
                    <a class="nav-link brc-success d-style" href="./bancos.php">
                    ...
                    <li class="nav-item">
                    <a class="nav-link brc-success d-style" href="./polizas.php">
                    ...
                    <!-- <li class="nav-item">
                    <a class="nav-link brc-success d-style" href="./inversion.php" >
                    ...
                    <!-- <li class="nav-item">
                    <a class="nav-link brc-success d-style" href="./consulta.php">
