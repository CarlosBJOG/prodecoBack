        ...
        <div class="navbar-inner">
          <div class="container container-plus">
            ...
            <div class="navbar-content d-none d-xl-flex border-l-1 brc-grey-l3">
              ...
              <?php if($actual == "/prodeco/c_vencidos/condonacion.php"){ ?>
                  <li class="breadcrumb-item text-dark-tp5"> <a class="text-dark-tp3" href="condonacion.php">Condonaci&oacute;n de Intereses</a></li>
              <?php }elseif($actual == "/prodeco/c_vencidos/reestructuracion.php"){ ?>
                  <li class="breadcrumb-item text-dark-tp5"> <a class="text-dark-tp3" href="index.php">Reestructuraci&oacute;n</a></li>
              <?php } elseif($actual == "/prodeco/c_vencidos/renovacion.php"){?>
                  <li class="breadcrumb-item text-dark-tp5"> <a class="text-dark-tp3" href="index.php">Renovaci&oacute;n</a></li>
              <?php } elseif($actual == "/prodeco/c_vencidos/castigo.php"){ ?>
                <li class="breadcrumb-item text-dark-tp5"> <a class="text-dark-tp3" href="index.php">Castigo de cr&eacute;dito</a></li>
                <?php }?>
                </ol>
            </div>
            ...
            <div class="d-inline-flex align-items-center input-floating-label brc-success-m1 px-lg-0">
                <ol class="breadcrumb pl-2 ml-3">
                    <li class="nav-item">
                        <a class="nav-link brc-success d-style" href="../c_vencidos/condonacion.php">
                    ...
                    <li class="nav-item">
                        <a class="nav-link brc-success d-style" href="reestructuracion.php">
                    ...
                    <li class="nav-item">
                        <a class="nav-link brc-success d-style" href="renovacion.php">
                    ...
                    <li class="nav-item">
                        <a class="nav-link brc-success d-style" href="castigo.php">
