        ...
        <div class="navbar-inner">
          <div class="container container-plus">
            ...
            <div class="d-inline-flex align-items-center input-floating-label brc-success-m1 px-lg-0">
                <ol class="breadcrumb pl-2 ml-3">
                    <li class="nav-item">
                        <a class="nav-link brc-success d-style" href="garantias.php">
                            <i class="fas fa-plus-square text-success-m2 mr-3px"></i>
                            <span class="d-n-active text-dark-tp5">Garantías depósito</span>
                            <span class="d-active text-success">Garantías depósito</span>
                        </a>
                    </li>

                    <li class="nav-item">
                        <a class="nav-link brc-success d-style" href="garantias_retiro.php">
                            <i class="fas fa-minus-square text-success-m2 mr-3px"></i>
                            <span class="d-n-active text-dark-tp5" >Garantías retiro</span>
                            <span class="d-active text-success">Garantías retiro</span>
                        </a>
                    </li>

                    <li class="nav-item">
                        <a class="nav-link brc-success d-style" href="seguroDeposito.php">
                            <i class="fa fa-lock text-success-m2 mr-3px"></i>
                            <span class="d-n-active text-dark-tp5">Seguro depósito</span>
                            <span class="d-active text-success">Seguro depósito</span>
                        </a>
                    </li>


                    <li class="nav-item">
                        <a class="nav-link brc-success d-style" href="segurosRetiro.php">
                            <i class="fas fa-lock-open text-success-m2 mr-3px"></i>
                            <span class="d-n-active text-dark-tp5">Seguro retiro</span>
                            <span class="d-active text-success">Seguro retiro</span>
                        </a>
                    </li>
