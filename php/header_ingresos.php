      ...
      <nav class="navbar navbar-sm navbar-fixed-sm navbar-expand-lg navbar-fixed" style="background-color: <?php echo $_SESSION["color"]; ?>20;">
        <div class="navbar-inner">
          <div class="container container-plus">
            ...
            <div class="navbar-intro justify-content-xl-start bg-transparent border-0 w-auto mr-lg-3 d-none d-sm-none d-md-block">
            ...
            <div class="navbar-content d-none d-xl-flex border-l-1 brc-grey-l3">
              ...
              <?php if($actual == "/prodeco/caja/cartera_transito_cajero.php"){ ?>

                  <li class="breadcrumb-item text-dark-tp5"> <a class="text-dark-tp3" href="index.php">Desembolso</a></li>

              <?php }elseif($actual == "/prodeco/ingresos/buro_credito_cajero.php"){ ?>
                  <li class="breadcrumb-item text-dark-tp5"> <a class="text-dark-tp3" href="index.php">Buró de crédito(cajero)</a></li>
              <?php } elseif($actual == "/prodeco/ingresos/gastos_caja.php"){?>
                  <li class="breadcrumb-item text-dark-tp5"> <a class="text-dark-tp3" href="gastos_caja.php">Gastos cobranza(Cajero)</a></li>
				<?php } elseif($actual == "/prodeco/ingresos/gastos_cobranza.php"){?>
                  <li class="breadcrumb-item text-dark-tp5"> <a class="text-dark-tp3" href="gastos_caja.php">Gastos cobranza(Promotor)</a></li>
              <?php } elseif($actual == "/prodeco/ingresos/quitar_pago.php"){ ?>
                <li class="breadcrumb-item text-dark-tp5"> <a class="text-dark-tp3" href="quitar_pago.php">Quitar pago</a></li>

              <?php } elseif($actual == "/prodeco/ingresos/buro_credito.php"){ ?>
                <li class="breadcrumb-item text-dark-tp5"> <a class="text-dark-tp3" href="buro_credito.php">Bur&oacute; de Cr&eacute;dito</a></li>

              <?php } elseif($actual == "/prodeco/ingresos/dacion_pago.php"){ ?>
                <li class="breadcrumb-item text-dark-tp5"> <a class="text-dark-tp3" href="dacion_pago.php">Daci&oacute;n de pago</a></li>

              <?php } elseif($actual == "/prodeco/ingresos/gastos_cobranza.php"){ ?>
                <li class="breadcrumb-item text-dark-tp5"> <a class="text-dark-tp3" href="gastos_cobranza.php">Gastos cobranza</a></li>
              <?php }?>
                </ol>
            </div>
          
            <?php if($_SESSION["tipo_usuario"]=='1' || $_SESSION["tipo_usuario"]=='4' || $_SESSION["tipo_usuario"]=='6'){  ?>
          
                <div  class="d-inline-flex align-items-center input-floating-label brc-success-m1 px-lg-0 ">
                    <ol class="navbar-nav ">

                        <li class="nav-item d-none d-sm-none d-md-block">
                            <a class="nav-link brc-success d-style " href="buro_credito.php">
                                <i class="fas fa-money-check-alt text-success-m2 mr-3px"></i>
                                <span class="d-n-active text-dark-tp5 " >Buró de crédito</span>
                            </a>
                        </li>

                        <li class="nav-item  d-none d-sm-none d-md-block">
                            <a class="nav-link brc-success d-style" href="gastos_caja.php">
                                <i class="fas fa-coins text-success-m2 mr-3px"></i>
                                <span class="d-n-active text-dark-tp5" >Gastos cobranza</span>
                    
                            </a>
                        </li>

                        <li class="nav-item  d-none d-sm-none d-md-block">
                            <a class="nav-link brc-success d-style" href="dacion_pago.php">
                                <i class="fa fa-handshake text-success-m2 mr-3px"></i>
                                <span class="d-n-active text-dark-tp5">Daci&oacute;n de pago</span>
                            </a>
                        </li>


                        <li class="nav-item  d-none d-sm-none d-md-block">
                            <a class="nav-link brc-success d-style" href="quitar_pago.php">
                                <i class="fas fa-user-minus text-success-m2 mr-3px"></i>
                                <span class="d-n-active text-dark-tp5">Quitar pago</span>
                ...
                <?php if($_SESSION["tipo_usuario"]=='1' || $_SESSION["tipo_usuario"]=='4' || $_SESSION["tipo_usuario"]=='6'){  ?>
                    <li class="nav-item dropdown d-block d-sm-block d-md-none">
                      <div class="navbar-content flex-grow-0 ml-auto">
                        <a href="buro_credito_cajero.php">
                          <button type="button" id="id-nav-post-btn" class="btn btn-outline-grey btn-h-outline-primary btn-h-text-grey btn-a-outline-primary btn btn-bold btn-brc-tp btn-sm mx-lg-2 px-2" href="#">
                            <i class="fa fa-handshake text-primary-m2 mr-3px"></i>
                            <span class="d-lg-inline ml-2">Buró de crédito</span>
                          </button>
                        </a>
                      </div>
                    </li> 
                    <li class="nav-item dropdown d-block d-sm-block d-md-none">
                      <div class="navbar-content flex-grow-0 ml-auto">
                          <a href="gastos_caja.php">
                            <button type="button" id="id-nav-post-btn2" class="btn btn-outline-grey btn-h-outline-primary btn-h-text-grey btn-a-outline-primary btn btn-bold btn-brc-tp btn-sm mx-lg-2 px-2">
                            <i class="fas fa-coins text-primary-m2 mr-3px"></i>
                            <span class="d-lg-inline ml-2">Gastos cobranza</span>
                            </button>
                          </a>
                      </div>
                    </li>
                    ...
                    <li class="nav-item dropdown d-block d-sm-block d-md-none">
                      <div class="navbar-content flex-grow-0 ml-auto">
                          <a href="dacion_pago.php">
                            <button type="button" id="id-nav-post-btn2" class="btn btn-outline-grey btn-h-outline-primary btn-h-text-grey btn-a-outline-primary btn btn-bold btn-brc-tp btn-sm mx-lg-2 px-2">
                            <i class="fa fa-handshake text-primary-m2 mr-3px"></i>
                            <span class="d-lg-inline ml-2">Daci&oacute;n de pago</span>
                            </button>
                          </a>
                      </div>
                    </li>
                    ...
                    <li class="nav-item dropdown d-block d-sm-block d-md-none">
                      <div class="navbar-content flex-grow-0 ml-auto">
                          <a href="quitar_pago.php">
                            <button type="button" id="id-nav-post-btn2" class="btn btn-outline-grey btn-h-outline-primary btn-h-text-grey btn-a-outline-primary btn btn-bold btn-brc-tp btn-sm mx-lg-2 px-2">
                            <i class="fas fa-user-minus text-primary-m2 mr-3px"></i>
                            <span class="d-lg-inline ml-2">Quitar pago</span>
                            </button>
                          </a>
                      </div>
                    </li>
