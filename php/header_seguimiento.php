<?php
//Control de accesos: solo administrador, promotor, supervisor 
...
function create_header_seguimiento()
{
?>
<!doctype html>
<html lang="en">
<head>
    ...
    <!-- include vendor stylesheets used in "Horizontal Menu" page. see "application/views/default/pages/partials/horizontal-menu/@vendor-stylesheets.hbs" -->
    <link rel="stylesheet" type="text/css" href="../ace-admin/node_modules/@fullcalendar/core/main.css">
    <link rel="stylesheet" type="text/css" href="../ace-admin/node_modules/@fullcalendar/daygrid/main.css">
    <link rel="stylesheet" type="text/css" href="../ace-admin/node_modules/@fullcalendar/timegrid/main.css">
...
function create_menu_seguimiento()
{
?>
          ...
          <div class="container container-plus">
            ...
            <div class="navbar-content d-none d-xl-flex border-l-1 brc-grey-l3">
                <ol class="breadcrumb pl-2 ml-3">
                  ...
                  <?php if($actual == "/prodeco/seguimiento/seguimiento-promotor.php"){ ?>

                    <li class="breadcrumb-item text-dark-tp5"> <a class="text-dark-tp3" href="index.php">Seguimiento-Promotor</a></li>

                  <?php }elseif($actual == "/prodeco/seguimiento/seguimiento-supervisor.php"){ ?>
                    <li class="breadcrumb-item text-dark-tp5"> <a class="text-dark-tp3" href="seguimiento-supervisor.php">Seguimiento-Supervisor</a></li>
                    <?php }?>
                </ol>
            </div>
              ...
              <div class="navbar-nav">
                <ul class="nav nav-compact has-active-border">
                  ...
                  <div class="dropdown-menu dropdown-caret dropdown-menu-right brc-success-m4">
                    ...
                    <a class="dropdown-item btn btn-outline-grey btn-h-lighter-success btn-a-lighter-success" href="../perfiles/perfil.php" taget="_blank">
