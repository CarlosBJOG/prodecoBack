<div id="" class="collapse show" aria-labelledby="datosGarantias" data-parent="#nuevoClienteAlta4">
        <div class="card-body text-grey-d3">
              <!-- MODAL -->
            <form id="formGarantia" name="formGarantia" action="">
              <div class="modal fade modal-lg" id="modalGarantia" tabindex="-1" role="dialog" aria-hidden="true">
                <div class="modal-dialog modal-dialog-scrollable" role="document">
                  <div class="modal-content">

                    <div class="modal-header">
                      <h5 class="modal-title text-success">Garant&iacute;a Retiro<span id="titulo"></span></h5>
                    ...
                    <div class="row">
                          <div class="col-sm-12 col-md-6 col-lg-6" style="margin-bottom: 8px; margin-top: 0px;">
                            <label class="col-form-label form-control-label" >Monto total de garant&iacute;a</label>
                    ...
                    <div class="modal-footer">
                      ...
                      <button type="button" id="btnRetirar" class="btn btn-success">Retirar</button>
