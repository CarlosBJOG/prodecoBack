<div id="" class="collapse show" aria-labelledby="datosGarantias" data-parent="#nuevoClienteAlta4">
        <div class="card-body text-grey-d3">
              <!-- MODAL -->
            <form id="formCobranza" name="formCobranza" action="">
              <div class="modal fade modal-lg" id="modalCobranza" tabindex="-1" role="dialog" aria-hidden="true">
                <div class="modal-dialog modal-dialog-scrollable" role="document">
                  <div class="modal-content">

                    <div class="modal-header">
                      <h5 class="modal-title text-success">Gastos Cobranza <span id="titulo"></span></h5>
                    ...
                    <div id="form_mueble">
                        ...
                        <div class="row">
                          ...
                          <div class="col-sm-12 col-md-6 col-lg-6" style="margin-bottom: 8px; margin-top: 0px;">
                            ...
                            <input type="text" name="concepto" id="concepto" value="Gasto de cobranza" class="form-control form-control-sm" disabled='true' required>
                          </div>            
                    ...
                    <div class="modal-footer">
                      ...
                      <button type="button" id="btnCobranza" class="btn btn-success">Aplicar cobro</button>
